...
export class GlobalService {
  ...
  getWeatherInfo(cityName: string, latitude?: string, longitude?: string) {
    if (cityName === undefined) {
      return this.http.get(`https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=da931ad4502df1d216edb321e2af6ecc&units=metric`)
    } else {
